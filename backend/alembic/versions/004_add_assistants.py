...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("SECURE", "SAAS_CHAT", "SAAS_RAG", name="assistanttype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "group_id", "assistant_id", "tenant_id", name="pk_groups_assistants"
        ),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
            ondelete="CASCADE",
            name="fk_groups_assistants_group_id",
        ),
        sa.ForeignKeyConstraint(
            ["assistant_id"],
            ["assistants.id"],
            ondelete="CASCADE",
            name="fk_groups_assistants_assistant_id",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenants.id"],
            ondelete="CASCADE",
            name="fk_groups_assistants_tenant_id",
        ),
    )
