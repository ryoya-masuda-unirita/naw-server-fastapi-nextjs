...
import { ButtonComponent, FormInputComponent, FormSwitchComponent } from '@app/shared/components';
...
@Component({
  selector: 'app-assistant-edit-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    FormInputComponent,
  ...
  templateUrl: './assistant-edit-dialog.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AssistantEditDialogComponent {
