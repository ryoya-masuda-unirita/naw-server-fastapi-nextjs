...
usage() {
  cat <<'EOF'
Usage:
  bash .codex/skills/naw-issue-workflow/scripts/project_status_sync.sh --issue <number> --status <status>
  bash .codex/skills/naw-issue-workflow/scripts/project_status_sync.sh --pr <number> --status <status>
